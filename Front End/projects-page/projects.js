...
const isDark = localStorage.getItem('theme') !== 'light'; // الدارك مود هو الافتراضي
...
function applyLanguage(lang) {
    ...
    fetchProjects(); // إعادة تحميل المشاريع باللغة الجديدة
}
...
async function fetchProjects() {
    ...
    let allProjects = [
        {
            title: "WeatherX",
            description: "متتبع طقس احترافي بواجهة عصرية وتنبؤات دقيقة.",
            descriptionEn: "Professional weather tracker with modern UI and accurate forecasts.",
            link: "https://mv7md.github.io/WeatherX/",
            category: "Front-End"
        }
    ];
